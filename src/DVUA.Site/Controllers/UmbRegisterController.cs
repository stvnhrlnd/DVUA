...
public class UmbRegisterController : SurfaceController
{
    ...
    public async Task<IActionResult> HandleRegisterMember(
        [Bind(Prefix = "registerModel")] Models.RegisterModel model)
    {
    ...
    private void MergeRouteValuesToModel(Models.RegisterModel model)
    {
    ...
    private async Task<IdentityResult> RegisterMemberAsync(Models.RegisterModel model)
    {
        ...
        if (identityResult.Succeeded)
        {
            ...
            _memberService.AssignRole(member.Id, model.RoleName);
